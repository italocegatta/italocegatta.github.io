...
coverCaption: "http://r4ds.had.co.nz"
...
```{r pacotes}
library(pacman)
p_load(readxl, dplyr, tidyr, httr)
```
...
GET("https://goo.gl/Av1fHP", write_disk(base_vespa1 <- tempfile(fileext = ".xlsx")))
...
GET("https://goo.gl/2AOmhx", write_disk(base_vespa2 <- tempfile(fileext = ".xlsx")))
```
...
Os arquivos utilizados nesse post pode ser baixados nesses links: [base_vespa1](https://goo.gl/Av1fHP) e [base_vespa2](https://goo.gl/2AOmhx)
